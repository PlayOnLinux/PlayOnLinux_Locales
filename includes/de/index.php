...
<div class="presentation_item" onclick="pres_show(1)"><img src="<?php echo $url; ?>/images/logos/logo48.png" alt="PlayOnLinux" /><span class="title"><!--I'd like to learn more about PlayOnLinux-->Ich möchte mehr über PlayOnLinux erfahren</span><span class="description"><!--What is PlayOnLinux?-->Was ist PlayOnLinux?</span></div>
<div id="pres_item1" class="presentation_item_hidden">
   <h2><!--What is PlayOnLinux ?-->Was ist PlayOnLinux?</h2>
   ...
   <h2>What are PlayOnLinux's features?--><!--#TODO#--></h2>
   <p><!--Here is a non-exhaustive list of the interesting points to know:--><!--#TODO#--></p>

	<ul>
   <li><!--You don't have to own a Windows&reg; license to use PlayOnLinux.-->Sie müssen keine Windows&reg; Lizenz besitzen um PlayOnLinux zu nutzen.</li>
   <li><!--PlayOnLinux is based on Wine, and so profits from all its features yet it keeps the user from having to deal with its complexity.-->
PlayOnLinux basiert auf Wine und profitiert von dessen Funktionen, wobei es dessen komplexität vom Benutzer fernhält.</li>
   <li><!--PlayOnLinux is free software.-->PlayOnLinux ist eine freie Software.</li>
   <li><!--PlayOnLinux uses Bash and Python.-->PlayOnLinux nutzt Bash und Python</li>
	</ul>
   <p><!--Nevertheless, PlayOnLinux has some bugs, as every piece of software:-->Nichtsdestotrotz, PlayOnLinux hat machen Fehler, wie alle Programme</p>
	<ul>
   <li><!--Occasional performance decrease (image may be less fluid and graphics less detailed).--><!--#TODO#--></li>
   <li><!--Not all games are supported. Nevertheless, you can use our manual installation module.-->Nicht alle Spiele werden unterstützt. Für solche Fälle gibt es eine manuelle Installation.</li>
	</ul>

<h2><!--A few screenshots of PlayOnLinux-->Ein paar Screenshots von PlayOnLinux</h2>
...
<span class='caption'><!--Main window-->Hauptfenster</span>
</div>
...
<span class='caption'><!--Install window-->Installationsfesnter</span>
</div>
...
<span class='caption'><!--Install wizard-->Installationsassistent</span>
</div>
...
<span class='caption'><!--Plugins-->Erweiterungen</span>
</div>
...
<span class='caption'><!--Wine versions-->Wine Versionen</span>
</div>

<div class="espace"></div>

</div>
<div class="presentation_item" onclick="pres_show(2)"><img src="<?php echo $url; ?>/images/design/icone2.png" alt="PlayOnLinux" />
<span class="title"><!--I'd like to download PlayOnLinux-->Ich möchte PlayOnLinux herunterladen</span>
<span class="description"><!--Latest version : -->Aktuellste Version<?php include($racine."/script_files/version2.php"); ?></span></div>
<div id="pres_item2" class="presentation_item_hidden">
<h2><!--Download PlayOnLinux-->PlayOnLinux herunterladen</h2>
<p><!--The latest version of PlayOnLinux is: -->Die aktuellste Version von PlayOnLinux ist<?php echo $version; ?><br /><!--To get this version, go to the-->um diese Version zu erhalten, gehe auf die <a href='<?php echo $prefixe; ?>/download.html'><!--download page-->Downlaodseite</a>.</p>
</div>
<div class="presentation_item" onclick="pres_show(3)"><img src="<?php echo $url; ?>/images/design/icone3.png" alt="PlayOnLinux" /><span class="title"><!--I'd like to learn how to use PlayOnLinux--><!--#TODO#--></span><span class="description">Where can I get help?</span></div>
