...
<span class='caption'>Fenêtre principale</span>
</div>
...
<span class='caption'>Installation de programmes</span>
</div>
...
<span class='caption'>Versions de wine</span>
</div>
...
if(isset($_COOKIE["LastNews_fr"]) && get_last_news("fr") == $_COOKIE["LastNews_fr"])
	$last = "";
else
	$last = "_2";
?>
